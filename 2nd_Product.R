...
# Read the HTML file
url <- "https://www.amazon.com/s?i=specialty-aps&bbn=16225007011&rh=n%3A16225007011%2Cn%3A11036071&ref=nav_em__nav_desktop_sa_intl_servers_0_2_6_13"
...
write.csv(product_df2, "2nd_Product.csv")


# Add "Category" column and set the value to "Servers"
product_df2$Category <- "Servers"
...
write.csv(product_df2, "2nd_Product_updated.csv", row.names = FALSE)
